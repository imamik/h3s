...
// runMainWithArgs runs the Execute function with the provided args and checks if the output contains the expected strings.
func runMainWithArgs(args []string, expectedOutput []string, t *testing.T) {
	...
	// Combine stdout, stderr, and execute error message
